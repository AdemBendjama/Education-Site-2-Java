...
<div class="containers">
    ...
    <div class="center-content">
        ...
        <div class="page-content">
            <form class="form" action="addContent" method="post">
                <ul>
                    <li>
                    ...
                    <li>
                        <label for="add-content-link">Content Link</label>
                        <input type="text" name="contentLink" id="add-content-link" required/>
                        <span>Enter Link to the Content [ Required ]</span>
                    </li>
                    <li>
                        <label for="add-content-name">Content Name</label>
                        <input type="text" name="contentName" id="add-content-name" required/>
                        <span>Choose a Name [ Required ]</span>
                    </li>
                    <li>
                        <label for="add-description">Description</label>
                        <input type="text" name="description" id="add-description" maxlength="300"/>
                        <span>Add/Change Description of The Week [ Optional ]</span>
                    </li>
                    <li>
